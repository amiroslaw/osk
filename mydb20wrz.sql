...
--
-- Host: localhost
-- Czas generowania: 20 Wrz 2015, 04:50
...
`idGrupa` int(11) NOT NULL,
  `nazwa` varchar(15) COLLATE utf8_polish_ci DEFAULT NULL,
  `idKategorie` int(11) DEFAULT NULL,
  `idWykladowcy` int(11) DEFAULT NULL
...
INSERT INTO `Grupy` (`idGrupa`, `nazwa`, `idKategorie`, `idWykladowcy`) VALUES
(1, 'B2015', 2, 2),
(2, 'A2015', 1, 1),
(3, 'B2014', 2, 2),
(4, 'A2015', 1, 1);
...
`idJAZDY` int(11) NOT NULL,
  ...
  `idINSTRUKTORZY` int(11) NOT NULL,
  `KLIENCI_idKLIENT` int(11) NOT NULL,
  `termin_rozpoczecia` datetime DEFAULT NULL,
  `termin_zakonczenia` datetime DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=29 ;

--
-- Zrzut danych tabeli `jazdy`
--

INSERT INTO `jazdy` (`idJAZDY`, `idPojazdy`, `idINSTRUKTORZY`, `KLIENCI_idKLIENT`, `termin_rozpoczecia`, `termin_zakonczenia`) VALUES
(1, 3, 11, 1, '2015-09-20 00:00:00', '2015-09-13 00:00:00'),
(3, 10, 22, 2, '2015-09-27 07:27:18', '2015-09-30 00:00:00'),
(13, 3, 11, 3, '2014-09-20 14:30:00', '2015-09-20 14:30:00'),
(14, 3, 11, 3, '2014-09-20 14:30:00', '2015-09-20 14:30:00'),
(19, 3, 11, 8, '2015-09-20 14:30:00', '2015-09-30 05:20:16'),
(24, 3, 32, 3, '2015-08-20 14:30:00', '2015-09-30 00:00:00'),
(25, 3, 32, 3, '2015-08-20 14:30:00', '2015-09-30 00:00:00'),
(26, 3, 27, 1, '2015-01-01 03:04:00', '2016-02-02 03:02:00'),
(28, 12, 17, 4, '2015-09-19 02:00:00', '2015-09-19 04:00:00');
...
INSERT INTO `klienci` (`idKLIENT`, `imie`, `nazwisko`, `data_urodzenia`, `plec`, `ulica`, `nr_mieszkania`, `miejscowosc`, `kod_pocztowy`, `email`, `nr_telefonu`, `typ`, `liczba_obecnosci_wyklady`, `wyjezdzone_godziny`, `status_kursu`, `KATEGORIE_idKategorie`, `idGrupa`) VALUES
(1, '$imie', '$nazwisko', '0000-00-00', '$plec', '$ulica', 0, '$miejscowosc', 0, '$email', 0, 0, 0, 0, '$status_kursu', NULL, NULL),
(2, 'Bartłomiej', 'Bartkowski', '1990-01-01', 'M', 'Słomkowa', 2, 'Lublin', 22111, 'bartek@poczta.pl', 333555555, 123, 1, 24, 'nowy', NULL, NULL),
(3, 'Wojciech', 'Wojciechowski', '1954-03-10', 'M', 'Tęczowa', 3, 'Kutno', 44555, 'wojtek@wp.pl', 123456777, 123, 6, 28, 'obecny', NULL, NULL),
(4, 'Anna', 'Nowik', '1992-02-03', 'K', 'Fiołkowa', 4, 'Jastrząbki', 18265, 'ania@poczta.pl', 876543234, 0, 5, 10, 'nowy', NULL, NULL),
(5, 'edytuj', 'Kolka', '0000-00-00', 'ela@wp.plK', '1998-03-03', 22456, '4', 0, 'Krosno', 0, 123, 1, 0, 'nowy', NULL, NULL),
(7, 'Kolka', 'Lolkowska', '1998-03-03', 'M', 'Lolkowa', 4, 'Krosno', 22456, 'julian@wp.pl', 123, 0, 4, 12, 'nowy', NULL, NULL),
(8, 'Julian', 'KrÃ³l', '1996-06-06', 'M', 'ZÅ‚ota', 19, 'Janki', 12333, 'krol@wp.pl', 999888111, 0, 0, 0, 'nowy', NULL, NULL),
(9, 'ElÅ¼bieta', 'JuliaÅ„ska', '1998-03-03', 'K', 'Pogodna', 23, 'Wyskoki', 90, 'elka@poczta.pl', 900, 1, 11, 0, 'obency', NULL, NULL),
(10, 'Anna', 'BuÅ‚ka', '1957-02-02', 'K', 'Chlebowa', 5, 'BaranÃ³w', 12999, 'abulka@poczta.pl', 345, 1, 343, 4656, 'nowy', NULL, NULL),
(11, 'edytuj', 'Arkadiusz ‚aw', '0000-00-00', 'm', 'gospodarcza', 11, 'Lublin', 4568, 'fff6@o2.pl', 78787, 1, 21, 11, 'nieaktywny', NULL, NULL);
...
`idPLATNOSCI` int(11) NOT NULL,
  ...
  `typ_platnosci` varchar(15) NOT NULL,
  `rodzaj_wplaty` varchar(11) DEFAULT NULL,
...
INSERT INTO `platnosci` (`idPLATNOSCI`, `idKLIENT`, `typ_platnosci`, `rodzaj_wplaty`, `nr_raty`, `kwota`) VALUES
(5, 5, 'przelew', 'rata', 1, 300),
(6, 5, 'przelew', 'rata', 1, 300);
...
(3, 'bmw', 'ciagnik', 1, '2015-09-10', 1, 'fjdis32', 'ubez434', '2015-09-18', 0, 1),
...
(13, 'Fiat', 'MOPAR', 0, '2015-09-20', 1, 'ERA45TL', '456465', '2015-09-11', 1, 2),
(14, 'Fiat', 'MOPAR', 0, '2015-09-19', -1, 'ERA45TL', '456465', '2015-09-25', 1, 2),
(15, 'Fiat', 'Punto', NULL, '2015-09-30', 1, 'LUB45TL', '345879', '2015-09-24', 1, 2);
...
(16, 'Kasia', 'Jaworska', 'hasło', 'k@jaworska.com');
...
--
ALTER TABLE `Grupy`
 ADD PRIMARY KEY (`idGrupa`), ADD KEY `idKategorie` (`idKategorie`), ADD KEY `idWykladowcy` (`idWykladowcy`);
...
--
ALTER TABLE `klienci`
 ADD PRIMARY KEY (`idKLIENT`), ADD KEY `KATEGORIE_idKategorie` (`KATEGORIE_idKategorie`), ADD KEY `idGrupa` (`idGrupa`);
...
--
ALTER TABLE `wyklad`
 ADD PRIMARY KEY (`idWyklad`), ADD KEY `fk_WYKLAD_KATEGORIE1_idx` (`idKategorie`), ADD KEY `fk_WYKLAD_WYKLADOWCY1_idx` (`idWykladowcy`), ADD KEY `idGrupa` (`idGrupa`);
...
--
ALTER TABLE `Grupy`
MODIFY `idGrupa` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `jazdy`
MODIFY `idJAZDY` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `platnosci`
MODIFY `idPLATNOSCI` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT dla tabeli `srodki_transportu`
--
ALTER TABLE `srodki_transportu`
MODIFY `idPojazdy` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `wykladowcy`
MODIFY `idWykladowcy` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `Grupy`
ADD CONSTRAINT `Grupy_ibfk_1` FOREIGN KEY (`idKategorie`) REFERENCES `kategorie` (`idKategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `Grupy_ibfk_2` FOREIGN KEY (`idWykladowcy`) REFERENCES `wykladowcy` (`idWykladowcy`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ADD CONSTRAINT `klienci_ibfk_1` FOREIGN KEY (`idGrupa`) REFERENCES `Grupy` (`idGrupa`) ON DELETE NO ACTION ON UPDATE SET NULL;
...
ADD CONSTRAINT `wyklad_ibfk_1` FOREIGN KEY (`idGrupa`) REFERENCES `Grupy` (`idGrupa`) ON DELETE NO ACTION ON UPDATE NO ACTION;
